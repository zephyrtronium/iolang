...
func (vm *VM) initNumber() {
	slots := Slots{
		...
		"factorial":          vm.NewTypedCFunction(NumberFactorial, "NumberFactorial()"),
		"floor":              vm.NewTypedCFunction(NumberFloor, "NumberFloor()"),
		"isAlphaNumeric":     vm.NewTypedCFunction(NumberIsAlphaNumeric, "NumberIsAlphaNumeric()"),
		"isControlCharacter": vm.NewTypedCFunction(NumberIsControlCharacter, "NumberIsControlCharacter()"),
		"isDigit":            vm.NewTypedCFunction(NumberIsDigit, "NumberIsDigit()"),
		"isEven":             vm.NewTypedCFunction(NumberIsEven, "NumberIsEven()"),
		"isHexDigit":         vm.NewTypedCFunction(NumberIsHexDigit, "NumberIsHexDigit()"),
		"isLetter":           vm.NewTypedCFunction(NumberIsLetter, "NumberIsLetter()"),
		"isLowercase":        vm.NewTypedCFunction(NumberIsLowercase, "NumberIsLowercase()"),
		"isNan":              vm.NewTypedCFunction(NumberIsNan, "NumberIsNan()"),
		"isOdd":              vm.NewTypedCFunction(NumberIsOdd, "NumberIsOdd()"),
		"isPrint":            vm.NewTypedCFunction(NumberIsPrint, "NumberIsPrint()"),
		"isPunctuation":      vm.NewTypedCFunction(NumberIsPunctuation, "NumberIsPunctuation()"),
		"isSpace":            vm.NewTypedCFunction(NumberIsSpace, "NumberIsSpace()"),
		"isUppercase":        vm.NewTypedCFunction(NumberIsUppercase, "NumberIsUppercase()"),
		"log":                vm.NewTypedCFunction(NumberLog, "NumberLog()"),
		"log10":              vm.NewTypedCFunction(NumberLog10, "NumberLog10()"),
		"max":                vm.NewTypedCFunction(NumberMax, "NumberMax(other)"),
		"min":                vm.NewTypedCFunction(NumberMin, "NumberMin(other)"),
		"mod":                vm.NewTypedCFunction(NumberMod, "NumberMod(v)"),
		"negate":             vm.NewTypedCFunction(NumberNegate, "NumberNegate()"),
		"pow":                vm.NewTypedCFunction(NumberPow, "NumberPow(v)"),
		"repeat":             vm.NewTypedCFunction(NumberRepeat, "NumberRepeat([counter,] message"),
		"round":              vm.NewTypedCFunction(NumberRound, "NumberRound()"),
		"roundDown":          vm.NewTypedCFunction(NumberRoundDown, "NumberRoundDown()"),
		"shiftLeft":          vm.NewTypedCFunction(NumberShiftLeft, "NumberShiftLeft(v)"),
		"shiftRight":         vm.NewTypedCFunction(NumberShiftRight, "NumberShiftRight(v)"),
		"sin":                vm.NewTypedCFunction(NumberSin, "NumberSin()"),
		"sqrt":               vm.NewTypedCFunction(NumberSqrt, "NumberSqrt()"),
		"squared":            vm.NewTypedCFunction(NumberSquared, "NumberSquared()"),
		"tan":                vm.NewTypedCFunction(NumberTan, "NumberTan()"),
		"toBase":             vm.NewTypedCFunction(NumberToBase, "NumberToBase(b)"),
