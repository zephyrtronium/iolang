...
func (vm *VM) initNumber() {
	slots := Slots{
		"*":                  vm.NewTypedCFunction(NumberMul),
		"+":                  vm.NewTypedCFunction(NumberAdd),
		"-":                  vm.NewTypedCFunction(NumberSub),
		"/":                  vm.NewTypedCFunction(NumberDiv),
		"abs":                vm.NewTypedCFunction(NumberAbs),
		"acos":               vm.NewTypedCFunction(NumberAcos),
		"asBinary":           vm.NewTypedCFunction(NumberAsBinary),
		"asCharacter":        vm.NewTypedCFunction(NumberAsCharacter),
		"asHex":              vm.NewTypedCFunction(NumberAsHex),
		"asLowercase":        vm.NewTypedCFunction(NumberAsLowercase),
		"asNumber":           vm.NewTypedCFunction(NumberAsNumber),
		"asOctal":            vm.NewTypedCFunction(NumberAsOctal),
		"asString":           vm.NewTypedCFunction(NumberAsString),
		"asUppercase":        vm.NewTypedCFunction(NumberAsUppercase),
		"asin":               vm.NewTypedCFunction(NumberAsin),
		"at":                 vm.NewTypedCFunction(NumberAt),
		"atan":               vm.NewTypedCFunction(NumberAtan),
		"atan2":              vm.NewTypedCFunction(NumberAtan2),
		"between":            vm.NewTypedCFunction(NumberBetween),
		"bitwiseAnd":         vm.NewTypedCFunction(NumberBitwiseAnd),
		"bitwiseComplement":  vm.NewTypedCFunction(NumberBitwiseComplement),
		"bitwiseOr":          vm.NewTypedCFunction(NumberBitwiseOr),
		"bitwiseXor":         vm.NewTypedCFunction(NumberBitwiseXor),
		"ceil":               vm.NewTypedCFunction(NumberCeil),
		"clip":               vm.NewTypedCFunction(NumberClip),
		"compare":            vm.NewTypedCFunction(NumberCompare),
		"cos":                vm.NewTypedCFunction(NumberCos),
		"cubed":              vm.NewTypedCFunction(NumberCubed),
		"exp":                vm.NewTypedCFunction(NumberExp),
		"factorial":          vm.NewTypedCFunction(NumberFactorial),
		"floor":              vm.NewTypedCFunction(NumberFloor),
		"isAlphaNumeric":     vm.NewTypedCFunction(NumberIsAlphaNumeric),
		"isControlCharacter": vm.NewTypedCFunction(NumberIsControlCharacter),
		"isDigit":            vm.NewTypedCFunction(NumberIsDigit),
		"isEven":             vm.NewTypedCFunction(NumberIsEven),
		"isHexDigit":         vm.NewTypedCFunction(NumberIsHexDigit),
		"isLetter":           vm.NewTypedCFunction(NumberIsLetter),
		"isLowercase":        vm.NewTypedCFunction(NumberIsLowercase),
		"isNan":              vm.NewTypedCFunction(NumberIsNan),
		"isOdd":              vm.NewTypedCFunction(NumberIsOdd),
		"isPrint":            vm.NewTypedCFunction(NumberIsPrint),
		"isPunctuation":      vm.NewTypedCFunction(NumberIsPunctuation),
		"isSpace":            vm.NewTypedCFunction(NumberIsSpace),
		"isUppercase":        vm.NewTypedCFunction(NumberIsUppercase),
		"log":                vm.NewTypedCFunction(NumberLog),
		"log10":              vm.NewTypedCFunction(NumberLog10),
		"max":                vm.NewTypedCFunction(NumberMax),
		"min":                vm.NewTypedCFunction(NumberMin),
		"mod":                vm.NewTypedCFunction(NumberMod),
		"negate":             vm.NewTypedCFunction(NumberNegate),
		"pow":                vm.NewTypedCFunction(NumberPow),
		"repeat":             vm.NewTypedCFunction(NumberRepeat),
		"round":              vm.NewTypedCFunction(NumberRound),
		"roundDown":          vm.NewTypedCFunction(NumberRoundDown),
		"shiftLeft":          vm.NewTypedCFunction(NumberShiftLeft),
		"shiftRight":         vm.NewTypedCFunction(NumberShiftRight),
		"sin":                vm.NewTypedCFunction(NumberSin),
		"sqrt":               vm.NewTypedCFunction(NumberSqrt),
		"squared":            vm.NewTypedCFunction(NumberSquared),
		"tan":                vm.NewTypedCFunction(NumberTan),
		"toBase":             vm.NewTypedCFunction(NumberToBase),
		"toggle":             vm.NewTypedCFunction(NumberToggle),
