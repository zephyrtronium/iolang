...
func (vm *VM) initDate() {
	...
	slots := Slots{
		...
		"convertToLocal":    vm.NewTypedCFunction(DateConvertToLocal, exemplar),
		"convertToLocation": vm.NewTypedCFunction(DateConvertToLocation, exemplar),
		"convertToUTC":      vm.NewTypedCFunction(DateConvertToUTC, exemplar),
		"copy":              vm.NewTypedCFunction(DateCopy, exemplar),
		"cpuSecondsToRun":   vm.NewCFunction(DateCpuSecondsToRun),
		"day":               vm.NewTypedCFunction(DateDay, exemplar),
		"fromNumber":        vm.NewTypedCFunction(DateFromNumber, exemplar),
		"gmtOffset":         vm.NewTypedCFunction(DateGmtOffset, exemplar),
		"gmtOffsetSeconds":  vm.NewTypedCFunction(DateGmtOffsetSeconds, exemplar),
		"hour":              vm.NewTypedCFunction(DateHour, exemplar),
		"isDST":             vm.NewTypedCFunction(DateIsDST, exemplar),
		"isPast":            vm.NewTypedCFunction(DateIsPast, exemplar),
		"isValidTime":       vm.NewCFunction(DateIsValidTime),
		"location":          vm.NewCFunction(DateLocation),
		"minute":            vm.NewTypedCFunction(DateMinute, exemplar),
		"month":             vm.NewTypedCFunction(DateMonth, exemplar),
		"now":               vm.NewTypedCFunction(DateNow, exemplar),
		"second":            vm.NewTypedCFunction(DateSecond, exemplar),
		"secondsSince":      vm.NewTypedCFunction(DateSecondsSince, exemplar),
		"secondsSinceNow":   vm.NewTypedCFunction(DateSecondsSinceNow, exemplar),
		"setDay":            vm.NewTypedCFunction(DateSetDay, exemplar),
		"setGmtOffset":      vm.NewTypedCFunction(DateSetGmtOffset, exemplar),
		"setHour":           vm.NewTypedCFunction(DateSetHour, exemplar),
		"setMinute":         vm.NewTypedCFunction(DateSetMinute, exemplar),
		"setMonth":          vm.NewTypedCFunction(DateSetMonth, exemplar),
		"setSecond":         vm.NewTypedCFunction(DateSetSecond, exemplar),
		"setToUTC":          vm.NewTypedCFunction(DateSetToUTC, exemplar),
		"setYear":           vm.NewTypedCFunction(DateSetYear, exemplar),
		"type":              vm.NewString("Date"),
		"year":              vm.NewTypedCFunction(DateYear, exemplar),
	}
