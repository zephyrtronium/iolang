...
func (vm *VM) initFile() {
	slots := Slots{
		"asBuffer":           vm.NewTypedCFunction(FileAsBuffer),
		"at":                 vm.NewTypedCFunction(FileAt),
		"atPut":              vm.NewTypedCFunction(FileAtPut),
		"close":              vm.NewTypedCFunction(FileClose),
		"contents":           vm.NewTypedCFunction(FileContents),
		"descriptor":         vm.NewTypedCFunction(FileDescriptor),
		"exists":             vm.NewTypedCFunction(FileExists),
		"flush":              vm.NewTypedCFunction(FileFlush),
		"foreach":            vm.NewTypedCFunction(FileForeach),
		"foreachLine":        vm.NewTypedCFunction(FileForeachLine),
		"isAtEnd":            vm.NewTypedCFunction(FileIsAtEnd),
		"isDirectory":        vm.NewTypedCFunction(FileIsDirectory),
		"isLink":             vm.NewTypedCFunction(FileIsLink),
		"isOpen":             vm.NewTypedCFunction(FileIsOpen),
		"isPipe":             vm.NewTypedCFunction(FileIsPipe),
		...
		"open":               vm.NewTypedCFunction(FileOpen),
		...
		"readBufferOfLength": vm.NewTypedCFunction(FileReadBufferOfLength),
		"readLine":           vm.NewTypedCFunction(FileReadLine),
		"readLines":          vm.NewTypedCFunction(FileReadLines),
		"readStringOfLength": vm.NewTypedCFunction(FileReadStringOfLength),
		"readToEnd":          vm.NewTypedCFunction(FileReadToEnd),
		"rewind":             vm.NewTypedCFunction(FileRewind),
		"setPath":            vm.NewTypedCFunction(FileSetPath),
		"setPosition":        vm.NewTypedCFunction(FileSetPosition),
