...
func TestPerform(t *testing.T) {
	...
	res := vm.ObjectWith(nil, []*iolang.Object{vm.BaseObject}, pt, performTesterTag{})
	anc := vm.NewObject(iolang.Slots{"t": res})
	target := anc.Clone()
...
func (performTesterTag) Activate(vm *iolang.VM, self, target, locals, context *iolang.Object, msg *iolang.Message) *iolang.Object {
...
func performTestForward(vm *iolang.VM, target, locals *iolang.Object, msg *iolang.Message) *iolang.Object {
...
func nilResult(vm *iolang.VM, target, locals *iolang.Object, msg *iolang.Message) *iolang.Object {
	return nil
}
